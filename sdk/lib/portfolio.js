...
class AdventPortfolio {
    constructor(program, address, authority, market, positionsKey, _variableDeposits, _fixedBorrows) {
    ...
    get variableDeposits() {
        return this._variableDeposits.filter((x) => x.token.toBase58() !== web3_js_1.PublicKey.default.toBase58());
    }
    get fixedBorrows() {
        return this._fixedBorrows.filter((x) => x.token.toBase58() !== web3_js_1.PublicKey.default.toBase58());
    }
